...
*/
controller.createZip = function(req, res){
  var entry = new zip({
...
*/
controller.getZips = function(req, res){
...
*/
controller.getZip = function(req, res){
...
*/
controller.getStateZips = function(req, res){
...
Given a municipality, returns all postal codes belonging to it.
  ...
  * Returns 200 and codes.
*/
controller.getMunicipalityZips = function(req, res){
